...
# DEFAULT_ROOT_PROMPT = (
#     "# Goals\n\n"
#     "Your primary goal is to help the user accomplish complex tasks. "
#     "When a request involves multiple aspects (e.g., technical applications, ethical considerations, and future developments), "
#     "**you must first break it down into smaller, manageable subtasks**.\n\n"
#     "**For each subtask, you should delegate to a sub-agent whenever possible**, even if tools are available.\n\n"
#     "Use your tools (e.g., `search`, `search_arxiv`) **only if the subtask is too simple or time-critical to delegate.**\n\n"
#     "**Always think before acting.** Outline the subtasks, explain your plan, and then decide whether to delegate or act directly.\n"
...
#         self.delegator = None
#         self.tools = []
#         self.task_description = None  # 記住自己被委派的任務
...
#         )
#         kani_inst.task_description = instructions  # ✅ 加這行：讓每個 agent 記得任務內容
